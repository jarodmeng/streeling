...
The results are bounded within the $[0, 1]$ range. The curve has an S-shape which make sense.

1. When $n \leq 3$, the probability of having four-of-a-kind is 0.2
...
$$
P(\text{four-of-a-kind}) = P(\text{exactly 1 four-of-a-kind}) + P(\text{exactly 2 four-of-a-kind}) + ... + P(\text{exactly 13 four-of-a-kind})
$$
...
$$
P(\text{exactly 1 four-of-a-kind}) = P(\text{1 four-of-a-kind}) \cdot [1 - P'(\text{exactly 1 four-of-a-kind})]
$$
...
$$
P'(\text{exactly 1 four-of-a-kind}) = \frac{\binom{12}{1} \cdot \binom{44}{n-8}}{\binom{48}{n-4}}
$$

$P(\text{1 four-of-a-kind})$ is the probability of having at least 1 four-of-a-kind. $P'(\text{exactly 1 four-of-a-kind})$ is the probability of having exactly 1 four-of-a-kind in the remaining 48 cards when a kind has already been drawn (to form the previous 1 four-of-a-kind). When $8 \leq n \leq 11$, $4 \leq n-4 \leq 7$, so the only possibility of having four-of-a-kind is to have exactly 1 four-of-a-kind in the remaining $n-4$ cards in the hand.
...
&= P(\text{exactly 2 four-of-a-kind}) + P(\text{1 four-of-a-kind}) \cdot [1 - P'(\text{exactly 1 four-of-a-kind})]\\
