...
The results match the simulation very well.

Out of curiosity, I plot the original and corrected results for $n \in [0, 28]$ with the formula results to see which one is "more accurate".
